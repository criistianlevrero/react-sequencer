  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-4xl mx-auto py-12 px-6">
        ...
        <Card className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Technologies Used</h2>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">UI Components</h3>
              <ul className="space-y-2 text-gray-600 dark:text-gray-300">
        ...
        <Card className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Features</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">🎵 Audio Engine</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">🎹 Sequencing</h3>
              <ul className="space-y-1 text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">🎛️ Interface</h3>
              <ul className="space-y-1 text-gray-600 dark:text-gray-300 text-sm">
        ...
        <Card>
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Development</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
